...
<html lang="en">
	<?php
		...
		if(isset($_POST['submit'])&&isset($_SESSION['Index_No']))
		{
			...
			$sql = "INSERT INTO students (Gr_No,Aadhar_No, Index_No,Student_Name,Father_Name,Mother_Name,Contact_No,Email_Id,DOB,Gender,Standard)
	...
	<head>
		...
		<title>Add School Representative</title>
	</head>
	<body>
			...
			<div class="row">
				<div class="col s12">
					<div id="main" class="card">
						...
						<h3><b>Register New School Representative</b></h3>
						</span>
							<div>
									...
									<form class="col s12" action="" id="form1" name="form1" method="post">
										<div class="row">
											<div class="input-field col s6">
												<input required id="school_index" name="school_index" type="text" autofocus placeholder="School Index" class="validate">
												
											</div>
											
										
											<div class="input-field col s6">
												<input required id="Representative_Name" onblur="name_validate(document.getElementById('Representative_Name'))" placeholder="Representative_Name	" name="Representative_Name" type="text" autofocus  class="validate">
