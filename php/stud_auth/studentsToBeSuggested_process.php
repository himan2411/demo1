<?php
   ...
   include("conn.php");
	...
	echo $sql1="SELECT `Aadhar_No` FROM `student` WHERE `Gr_No` = '".$Gr_No."' and `Index_No`='".$Index_No."'";
	$result1 = $conn->query($sql1);
	$row1 = $result1->fetch_assoc();
	
	echo $sql2="SELECT `R_Name` FROM `school_representative` WHERE `Index_No` = '".$Index_No."' ";
