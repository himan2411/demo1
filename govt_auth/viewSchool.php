...
<body>
    ...
    <select name="School_Type" value="<?php  
	
	if( $_SESSION['School_Type'] == '0')
			{
				echo "Rural";
			}
			else{
	...
	?>" id="School_Type" onchange="this.form.submit()">
...
<!--  <form action="">
  ...
  <table class="responsive">
        ...
        <tbody>
		 <?php 
		  $sql = "SELECT * FROM `schools` WHERE `Index_No` IS NOT NULL ";
