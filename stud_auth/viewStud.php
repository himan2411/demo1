...
<!--a class="waves-effect waves-light btn">Submit</a-->                                  
        ...
        <tbody>
			...
			$aaa= $_GET['ac'];
				 ...
				 $sql = "SELECT * FROM `students` where Index_No = '$Index_No' AND Standard='$aaa'";
		...
		?>
		 <tr>
            ...
            <td><?php 
				...
				$_SESSION["Aadhar_No"] =$row1['Aadhar_No'];
               ...
               <div class="modal-content">
                  ...
                  <h4>Student's Information</h4>
					...
					<div class="row">
							  ...
							  <div class="input-field col s6">
											  <input id="Aadhar_No" type="text" class="datepicker" onblur="date_validate()">
											  <label for="Aadhar_No">Aadhar_No: <?php echo $row1['Aadhar_No'];?></label>
											  <?php$_SESSION["Aadhar_No"] = $row1['Aadhar_No']	;?>
							</div>
					</div>  
                  <div class="row">
					  ...
					  <div class="input-field col s6">
                                ...
                                <label for="GR_no">G.R. Number: 
								<?php 
									echo $_SESSION["Gr_No"] = $grnum;
									?>
									</label>
                      </div>
					  <div class="input-field col s6">
                ...
                <h4>School Academic</h4>
						...
						<h4>Extra Curriculum</h4>
										...
										<form action="..\s3\uploader1.php" method="POST">
												<input type="submit" value="Upload Certi photo">
										</form>
