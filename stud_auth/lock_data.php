	...
	$Index_No=$_SESSION['Index_No'];
			...
			$sql = "SELECT * FROM `students` where  Index_No='$Index_No'";
	  ...
	  { 	
			...
			if($row1['Status']=='1')
			{
				...
				$sql1="UPDATE students SET Standard='$temp5',Percentage=0,C_Percentage='$temp',Ext_Academics=0,C_Ext_Academics='$temp1',Ext_Sports=0,
			C_Ext_Sports='$temp2',Ext_Cultural=0,C_Ext_Cultural='$temp3',Status=NULL WHERE Gr_No='$temp4' AND Index_No='$Index_No'";
					$conn->query($sql1);
				...
				$sql4="INSERT INTO warehouses(Gr_No,Aadhar_No, Student_Name, Father_Name,Mother_Name, Percentage, Ext_Academics,Ext_Cultural,Ext_Sports,Credit_Score,Certi_Link)
